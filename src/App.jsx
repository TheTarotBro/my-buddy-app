...
function EnvironmentBg({ envId, width = 320, height = 180 }) {
  ...
  if (envId === "park") return (
    <svg width={w} height={h} viewBox={`0 0 ${w} ${h}`} style={{position:"absolute",bottom:0,left:"50%",transform:"translateX(-50%)"}}>
      ...
      {/* Stars */}
      <circle cx={w*0.15} cy={h*0.08} r="1.5" fill="#5a4a3e" opacity="0.3"/><circle cx={w*0.5} cy={h*0.05} r="1" fill="#5a4a3e" opacity="0.25"/>
      <circle cx={w*0.8} cy={h*0.1} r="1.5" fill="#5a4a3e" opacity="0.2"/><circle cx={w*0.35} cy={h*0.12} r="1" fill="#5a4a3e" opacity="0.15"/>
      {/* Moon */}
  ...
  if (envId === "beach") return (
    <svg width={w} height={h} viewBox={`0 0 ${w} ${h}`} style={{position:"absolute",bottom:0,left:"50%",transform:"translateX(-50%)"}}>
      ...
      {/* Stars */}
      <circle cx={w*0.3} cy={h*0.06} r="1.5" fill="#5a4a3e" opacity="0.3"/><circle cx={w*0.55} cy={h*0.1} r="1" fill="#5a4a3e" opacity="0.2"/>
      <circle cx={w*0.7} cy={h*0.04} r="1.5" fill="#5a4a3e" opacity="0.25"/><circle cx={w*0.45} cy={h*0.15} r="1" fill="#5a4a3e" opacity="0.15"/>
      {/* Moon */}
